...
public class ExcelExportForMap {
    ...
    public void test() {
        try {
            ...
            ExcelExportEntity excelentity = new ExcelExportEntity("课程", "cur");
            excelentity.setNeedMerge(true);
            entity.add(excelentity);
            entity.add(new ExcelExportEntity("老师", "laoshi"));
            ...
            response.setHeader("Content-disposition",
                    "attachment; filename=" + new String("测试".getBytes("utf-8"), "ISO8859-1"));
            //构造输出流
